# Instructions template {#instructions-YJR status=ready}
...
## Video of expected results {#demo-YJR-expected}
...
## Laptop setup notes {#demo-YJR-laptop-setup}

Does the user need to do anything to modify their local laptop configuration?


## Duckietown setup notes {#demo-YJR-duckietown-setup}
...
## Duckiebot setup notes {#demo-YJR-duckiebot-setup}
...
## Pre-flight checklist {#demo-YJR-pre-flight}
...
## Troubleshooting {#demo-YJR-troubleshooting}
...
## Demo failure demonstration {#demo-YJR-failure}
